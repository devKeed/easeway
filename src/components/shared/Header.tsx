...
const Header = () => {
 ...
 <p className="text-[#0E2127] font-axiforma font-bold text-body leading-tight text-body font-uber">
 Easeway Medicare
 </p>
 <p className="text-[#0E2127]/70 text-body font-uber text-body font-uber">
 ...
 <div>
 <p className="text-[#0E2127]/60 text-body font-uber">Call us</p>
 <a
 href="tel:+447460091561"
 ...
 <div>
 <p className="text-[#0E2127]/60 text-body font-uber">Location</p>
 <p className="text-body font-uber">Whittlesey, Peterborough</p>
 </div>
 </div>
 </div>
