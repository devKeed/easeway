...
"Home Physiotherapy Care",
 ...
 <p className="text-body text-gray-600 max-w-3xl mx-auto text-body font-uber">
 ...
 <h3 className="text-h3-mobile md:text-h2-desktop font-axiforma text-[#0E2127] mb-6">
 ...
 <p className="text-[#FF3133] font-semibold text-body font-uber">Book Online</p>
 </div>
 </div>

 <p className="text-gray-600 mb-4 text-body font-uber">
 Click the form to book your appointment online
 </p>

 <div className="bg-white p-4 rounded-lg">
 <p className="text-body text-gray-500 mb-2 text-body font-uber">
 Or call us directly:
 </p>
 <a
 href="tel:+447460091561"
 className="text-h3-mobile md:text-h2-desktop font-axiforma text-[#FF3133] hover:underline"
 >
 +44 7460 091561
 </a>
 </div>
 ...
 <button
 type="submit"
 className="w-full bg-[#FF3133] text-white py-4 px-6 rounded-lg text-h5-mobile md:text-h4-desktop font-axiforma hover:bg-[#e62a2c] transition-all duration-300 shadow-lg hover:shadow-xl"
 >
 Book Now
 </button>
 </form>
