...
export const ServiceCard = ({
 ...
 >
 <h3 className="text-body-lg md:text-3xl font-medium uppercase text-gray-800 mt-0 lg:mt-10">
 {title}
 </h3>
 <p className="text-body mt-2 font-uber text-body font-uber">{description}</p>
 <div className="mt-3">
 <h5 className="text-body sm:text-body-lg md:text-2xl font-medium text-gray-800 mt-2 md:mt-7">
 WHAT WE MANAGE:
 </h5>
 ...
 >
 <p className="text-body px-2 md:px-3 text-body font-uber">
 {feature}
 </p>
 </span>
 ))}
 ...
 <div className="mt-4">
 <h5 className="text-body sm:text-body-lg md:text-2xl font-medium text-gray-800 mt-7">
 LET'S BREAK IT DOWN:
 </h5>
 <p className="text-gray-700 mt-1 text-body font-uber">{breakdown}</p>
 </div>
 </motion.div>
 <motion.div
