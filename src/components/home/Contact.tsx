...
const Contact = () => {
 ...
 <p className="text-body text-gray-600 max-w-2xl mx-auto leading-relaxed font-light font-uber px-4 text-body font-uber">
 ...
 <div>
 <h4 className="text-h6-mobile md:text-h5-desktop font-axiforma text-gray-900 mb-1 sm:mb-2">
 Phone
 </h4>
 <a
 ...
 <p className="text-body text-gray-600 font-light text-body leading-relaxed text-body font-uber">
 ...
 <p className="text-body text-white mb-2 font-uber text-body font-uber">Book Now</p>
 </div>
 </button>

 <p className="text-body text-gray-600 font-light mb-6 text-body font-uber">
 ...
 <a
 href="tel:+447460091561"
 className="text-body font-axiforma text-gray-900 hover:text-gray-600 transition-colors"
 >
 +44 7460 091561
 </a>
 </div>
