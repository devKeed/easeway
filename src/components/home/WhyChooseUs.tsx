...
"Focused on long-term wellness. Treating the whole person for lasting recovery, addressing not just symptoms but underlying causes.",
 ...
 viewport={{ once: true }}
 >
 <h2 className="text-h2-mobile sm:text-h2-desktop md:text-h1-mobile lg:text-h1-desktop font-axiforma mb-3 sm:mb-4 flex items-center justify-center gap-2 sm:gap-3">
 ...
 <h3 className="text-body-lg sm:text-h3-mobile md:text-h2-desktop font-axiforma text-[#0E2127] mb-3 sm:mb-4">
