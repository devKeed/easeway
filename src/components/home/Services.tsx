...
"The only provider of this service in Whittlesey - professional care in the comfort of your home.",
 ...
 <motion.h2
 className="text-h2-mobile sm:text-h2-desktop md:text-h1-mobile lg:text-h1-desktop font-axiforma text-gray-900 mb-6 sm:mb-8 mt-4 tracking-tight max-w-xl mx-auto leading-tight"
