...
const TimeSlotSelector: React.FC<TimeSlotSelectorProps> = ({
 ...
 <p className="text-yellow-800 font-medium text-body font-uber">No available time slots</p>
 {message && <p className="text-yellow-700 text-body mt-1 text-body font-uber">{message}</p>}
 </div>
 </div>
 );
 }
 ...
 return (
 <div className="mb-4">
 <h4 className="text-body-sm font-axiforma text-gray-700 mb-2">{title}</h4>
 ...
 <p className="text-body text-gray-500 mt-1 text-body font-uber">
