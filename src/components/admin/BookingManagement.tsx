...
"Content-Type":"application/json",
 ...
 <p className="text-body text-gray-600 font-uber text-body font-uber">#{booking.confirmationNumber}</p>
 </div>
 <button
 onClick={() => {
 ...
 <p className="text-body font-axiforma text-gray-700 mb-1 font-uber text-body font-uber">Service:</p>
 <p className="text-body text-gray-600 font-uber text-body font-uber">{booking.service}</p>
 </div>
 ...
 <p className="text-gray-900 text-body font-uber">{selectedBooking.name}</p>
 </div>
 <div>
 <label className="text-body-sm font-axiforma text-gray-700">
 Email
 </label>
 <p className="text-gray-900 text-body font-uber">{selectedBooking.email}</p>
 </div>
 <div>
 <label className="text-body-sm font-axiforma text-gray-700">
 Phone
 </label>
 <p className="text-gray-900 text-body font-uber">{selectedBooking.phone}</p>
 </div>
 ...
 <p className="text-gray-900 text-body font-uber">{selectedBooking.service}</p>
 </div>
 <div>
 <label className="text-body-sm font-axiforma text-gray-700">
 Date
 ...
 >
 <div className="text-h3-mobile md:text-h2-desktop font-axiforma">{totalBookings}</div>
 ...
 <h3 className="text-h5-mobile md:text-h4-desktop font-axiforma mb-2">No bookings found</h3>
