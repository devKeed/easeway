  ...
  const TimeSlot = ({ date, time }: { date: string; time: string }) => {
    ...
    return (
      <div
        ...
        className={`
          p-2 border rounded text-xs cursor-pointer transition-all min-h-[60px] relative
      ...
      >
        ...
        {booking && (
          <div className="mt-1">
            ...
            <div className="text-xs opacity-75">{booking.service}</div>
            <div className="text-xs">#{booking.confirmationNumber}</div>
          </div>
        )}
        {blocked && (
          <div className="mt-1">
            ...
            <div className="text-xs opacity-75">{blocked.reason}</div>
          </div>
        )}
      ...
      <div className="flex items-center justify-between bg-white p-4 rounded-lg shadow-sm">
        ...
        <div className="text-center">
          ...
          <button
            ...
            className="text-sm text-[#FF3133] hover:underline"
          >
            Go to Today
          </button>
        </div>
