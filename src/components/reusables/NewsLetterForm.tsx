...
export const NewsLetterForm: React.FC<NewsLetterFormProps> = ({
  ...
  return (
    <div className="w-full space-y-4 flex flex-col justify-center items-center">
      ...
      <p className="text-gray-700 text-center text-body font-uber">
            ...
            <div id="mc_embed_signup_scroll">
              <div className="mc-field-group mb-4">
                <input
                  ...
                  className="border border-gray-300 rounded-md px-3 py-2 text-base w-full focus:outline-none focus:border-[#F2720D]"
                  id="mce-FNAME"
                />
              </div>
              <div className="mc-field-group mb-4">
              ...
              <div className="flex m-auto text-center">
                <button
                  ...
                  className="bg-[#F2720D] hover:bg-[#f24a0d] text-white py-3 px-8 rounded-xl text-button-sm font-uber transition-colors duration-300 flex items-center justify-center min-w-[120px]"
                >
                  Subscribe
                </button>
              </div>
      ...
      {showToast && (
        ...
        >
          ...
          <button
            ...
            className="ml-2 text-base underline hover:no-underline"
          >
            Close
          </button>
        </div>
