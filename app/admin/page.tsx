...
const AdminDashboard = () => {
 ...
 <h1 className="text-h3-mobile md:text-h2-desktop font-axiforma text-[#0E2127]">
 Admin Dashboard
 </h1>
 <p className="text-gray-600 text-body font-uber">Welcome back, {user?.name}</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-gray-600 text-body font-uber">Total Bookings</p>
